...
import com.other.Constants.FASTEST_LOCATION_INTERVAL
import com.other.Constants.LOCATION_UPDATE_INTERVAL
...
import com.other.Constants.TIMER_UPDATE_INTERVAL
...
class TrackingService:LifecycleService() {
    ...
    companion object{ //Used so that can be observered from outside the service
